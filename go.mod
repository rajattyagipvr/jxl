...
replace (
	github.com/jenkins-x/jx => github.com/rajattyagipvr/jx v0.0.0-20200720075024-63262aceb57f
	github.com/jenkins-x/jx v0.0.0-20200407063749-f19676961cb7 => github.com/rajattyagipvr/jx v0.0.0-20200720075024-63262aceb57f
)
